...
use AppBundle\Model\ProductPeer;
use AppBundle\Model\map\ProductTableMap;
...
abstract class BaseProductPeer
{
    ...
    const OM_CLASS = 'AppBundle\\Model\\Product';

    /** the related TableMap class for this table */
    const TM_CLASS = 'AppBundle\\Model\\map\\ProductTableMap';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Price', 'Description', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'price', 'description', ),
        BasePeer::TYPE_COLNAME => array (ProductPeer::ID, ProductPeer::NAME, ProductPeer::PRICE, ProductPeer::DESCRIPTION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'PRICE', 'DESCRIPTION', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'price', 'description', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Price' => 2, 'Description' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'price' => 2, 'description' => 3, ),
        BasePeer::TYPE_COLNAME => array (ProductPeer::ID => 0, ProductPeer::NAME => 1, ProductPeer::PRICE => 2, ProductPeer::DESCRIPTION => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'PRICE' => 2, 'DESCRIPTION' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'price' => 2, 'description' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseProductPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \AppBundle\Model\map\ProductTableMap());
      }
    }

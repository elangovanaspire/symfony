...
use Acme\DemoBundle\Model\UserPeer;
use Acme\DemoBundle\Model\map\UserTableMap;
...
abstract class BaseUserPeer
{
    ...
    const OM_CLASS = 'Acme\\DemoBundle\\Model\\User';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Acme\\DemoBundle\\Model\\map\\UserTableMap';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'Email', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'email', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID, UserPeer::USERNAME, UserPeer::EMAIL, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USERNAME', 'EMAIL', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'username', 'email', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'Email' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'email' => 2, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID => 0, UserPeer::USERNAME => 1, UserPeer::EMAIL => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USERNAME' => 1, 'EMAIL' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'username' => 1, 'email' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseUserPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Acme\DemoBundle\Model\map\UserTableMap());
      }
    }

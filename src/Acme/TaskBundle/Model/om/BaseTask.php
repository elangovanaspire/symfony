...
abstract class BaseTask extends BaseObject implements Persistent
{
    ...
    public function setTags($v)
    {
        ...
        if ($this->tags !== $v) {
            $this->tags = $v;
            $this->modifiedColumns[] = TaskPeer::TAGS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->tags = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = TaskPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TaskPeer::TAGS)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setTags($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TaskPeer::TAGS)) $criteria->add(TaskPeer::TAGS, $this->tags);
     ...
     *
     * @return string The value of the 'description' column
     */

 ...
 * @method TaskQuery orderByTags($order = Criteria::ASC) Order by the tags column
 *
 * @method TaskQuery groupById() Group by the id column
 * @method TaskQuery groupByDescription() Group by the description column
 * @method TaskQuery groupByTags() Group by the tags column
 *
 ...
 * @method Task findOneByTags(string $tags) Return the first Task filtered by the tags column
 *
 ...
 * @method array findByTags(string $tags) Return Task objects filtered by the tags column
 */
abstract class BaseTaskQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `description`, `tags` FROM `task` WHERE `id` = :p0';
        try {
    ...
    public function filterByTags($tags = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(TaskPeer::TAGS, $tags, $comparison);
    }

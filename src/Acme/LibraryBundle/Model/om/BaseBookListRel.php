...
abstract class BaseBookListRel extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Acme\\LibraryBundle\\Model\\BookListRelPeer';
     ...
     * @return BookListRel The current object (for fluent API support)
     */
    public function setBookId($v)
    {
        ...
        if ($this->book_id !== $v) {
            $this->book_id = $v;
            $this->modifiedColumns[] = BookListRelPeer::BOOK_ID;
        }
    ...
    public function setBookClubListId($v)
    {
        ...
        if ($this->book_club_list_id !== $v) {
            ...
            $this->modifiedColumns[] = BookListRelPeer::BOOK_CLUB_LIST_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->book_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->book_club_list_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = BookListRelPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating BookListRel object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BookListRelPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BookListRelQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BookListRelPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BookListRelPeer::BOOK_ID)) {
            $modifiedColumns[':p' . $index++]  = '`book_id`';
        }
        if ($this->isColumnModified(BookListRelPeer::BOOK_CLUB_LIST_ID)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aBookClubList !== null) {
                if (!$this->aBookClubList->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aBookClubList->getValidationFailures());
                }
            }


            if (($retval = BookListRelPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BookListRelPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $keys = BookListRelPeer::getFieldNames($keyType);
        $result = array(
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aBookClubList) {
                $result['BookClubList'] = $this->aBookClubList->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setBookClubListId($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BookListRelPeer::BOOK_ID)) $criteria->add(BookListRelPeer::BOOK_ID, $this->book_id);
        if ($this->isColumnModified(BookListRelPeer::BOOK_CLUB_LIST_ID)) $criteria->add(BookListRelPeer::BOOK_CLUB_LIST_ID, $this->book_club_list_id);
    ...
    {
        $criteria = new Criteria(BookListRelPeer::DATABASE_NAME);
        $criteria->add(BookListRelPeer::BOOK_ID, $this->book_id);
        $criteria->add(BookListRelPeer::BOOK_CLUB_LIST_ID, $this->book_club_list_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of BookListRel (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BookListRel Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BookListRelPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BookListRelPeer();
        }
     ...
     * @throws PropelException
     */
    public function getBook(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBook === null && ($this->book_id !== null) && $doQuery) {
            $this->aBook = BookQuery::create()->findPk($this->book_id, $con);
    ...
    /**
     * Declares an association between this object and a BookClubList object.
     *
     * @param                  BookClubList $v
     * @return BookListRel The current object (for fluent API support)
     * @throws PropelException
     */
    public function setBookClubList(BookClubList $v = null)
    {
        if ($v === null) {
        ...
        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the BookClubList object, it will not be re-added.
        if ($v !== null) {
            $v->addBookListRel($this);
        }
    ...
    /**
     * Get the associated BookClubList object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return BookClubList The associated BookClubList object.
     * @throws PropelException
     */
    public function getBookClubList(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBookClubList === null && ($this->book_club_list_id !== null) && $doQuery) {
            $this->aBookClubList = BookClubListQuery::create()->findPk($this->book_club_list_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aBook instanceof Persistent) {
              $this->aBook->clearAllReferences($deep);
            }
            if ($this->aBookClubList instanceof Persistent) {
              $this->aBookClubList->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(BookListRelPeer::DEFAULT_STRING_FORMAT);
    }

...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Acme.LibraryBundle.Model.map.AuthorTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Acme\\LibraryBundle\\Model\\Author');
    ...
    {
        $this->addRelation('Book', 'Acme\\LibraryBundle\\Model\\Book', RelationMap::ONE_TO_MANY, array('id' => 'author_id', ), null, null, 'Books');
    } // buildRelations()
